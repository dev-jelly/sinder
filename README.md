...
[macOS Apple Silicon용 0.5.2 프리뷰 다운로드](https://github.com/dev-jelly/sinder/releases/tag/v0.5.2)
...
0.5.2는 원격→Finder 복사가 대기 상태로 멈추는 문제를 수정한 프리뷰입니다. 수신 측 쓰기 조정과 실제 SSH 다운로드를 함께 재현한 회귀 테스트가 통과했고, 맥북의 별도 개발용 진단 창에서도 SSH 테스트 파일의 Finder 복사와 전달 완료 로그를 확인했습니다. 배포 앱은 Developer ID 서명과 Apple 공증을 완료했습니다. 실제 사용 서버와 여러 파일·폴더의 드래그는 추가 실기 확인을 진행하고 있습니다.
