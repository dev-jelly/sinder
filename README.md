...
macOS 배포용 서명·공증 릴리스를 준비하고 있습니다. 배포 파일은 [GitHub Releases](https://github.com/dev-jelly/sinder/releases)에 게시합니다. 현재는 아래의 [소스에서 실행하기](#소스에서-실행하기)를 사용할 수 있습니다. Windows 실기 검증과 Windows 배포는 아직 진행하지 않았습니다.
